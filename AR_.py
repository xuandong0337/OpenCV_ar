...
if __name__ == "__main__":
    ...
    dist_coeff = np.array([ 0.04498289, -0.22470724, -0.00337165,  0.00902588,  0.41894672]) 
    
    #cap = cv2.VideoCapture(0)
   # print("1111111111")
    #ret, frame = cap.read()
    #cap.draw_background(frame)
    #print("2222222222")
    #gray = cv2.cvtColor(frame, cv2.COLOR_BGR2GRAY)    

    #dictionary = aruco.Dictionary_get(aruco.DICT_ARUCO_ORIGINAL)
    #parameters =  aruco.DetectorParameters_create()
    #markerCorners, ids, rejectedCandidates = aruco.detectMarkers(gray, dictionary, parameters=parameters)
    
    
    #print(ids)
    #if ids == 1:    
      # ar_instance = AR_render(cam_matrix, dist_coeff, './Models/gs8/untitled05.obj', model_scale = 0.03)
     #  print("44444")
   # elif ids == 2:
      # ar_instance = AR_render(cam_matrix, dist_coeff, './Models/Box/box.obj', model_scale = 0.03)
   # else:
    ar_instance = AR_render(cam_matrix, dist_coeff, './Models/Zheng/box.obj', model_scale = 0.03)  
       #print("5555")
    ar_instance.run() 
